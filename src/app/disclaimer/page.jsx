      ...
      <div>
        <div className="container mx-auto px-6 py-12 mt-16">
          ...
          <p className="text-white-600 z-50 mb-4">
            ...
            statements made by Gurukulskills.site advertisers / sponsors are
            projections only of what we assume you might earn. There is no
            assurance that you will make those income levels and you accept the
          ...
          <p className="text-white-600 z-50 mb-4">
            ...
            desired product does not guarantee any profit or financial return
            whatsoever.
          </p>
          ...
          <p className="text-white-600 z-50 mb-4">
            ...
            company which is directly or indirectly linked to the purchase and
            use of our information, products and services reviewed or promoted
            on this website.
          </p>
          ...
          <p className="text-white-600 z-50">
            ...
            internet that we cannot foresee which could reduce the results you
            experience. We are not responsible for your actions.
          </p>
        </div>
      </div>
      <Footer />
