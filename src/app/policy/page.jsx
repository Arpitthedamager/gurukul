    ...
    <>
      ...
      <div className="container mx-auto px-6 py-12 mt-16 mb-16">
        ...
        <p className="text-white z-50 mb-4">
          1. We issue refunds for the purchases within 2 hours of the original
          purchase of the packages.
        </p>

        <p className="text-white z-50 mb-4">
          2. A payment gateway fee @ 2% of the paid amount and processing fee
        ...
        <p className="text-white z-50 mb-4">
          4. For the refund, you need to mail at{" "}
          <a href="#" className=" text-blue-700 ">
            gurukulskiils57@gmail.com/
          </a>{" "}
          with registered e-mail ID only
        </p>

        <p className="text-white z-50 mb-4">
          5.Full Name Registered e-mail IDRegistration dateScreen shot of
          Payment Invoice with date and time
        </p>
