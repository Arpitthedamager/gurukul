...
const SubscriptionPackage = () => {
    ...
    const subscriptionData = {
        ...
        description: "This subscription package is designed to help you build a strong narrative in the professional realm. If you want to make your career in social media marketing, then this package is for you. With a wide range of topics, this package makes you a prominent leader in the business sector. From enhancing your professional skills to improving your mental flexibility, this package is a game-changer for your overall growth.",
        price: "$99",
        originalPrice: "$199",
        includes: [
    ...
    return (
        ...
        <div className="font-sans max-w-4xl mt-16 pt-16 mx-auto px-4 py-8 border border-gray-200 rounded-lg shadow-lg bg-gradient-to-r from-gray-100 to-white">
            ...
            <div className="text-center mb-8">
                <h1 className="text-5xl font-bold mb-4 text-gray-900">{subscriptionData.title}</h1>
                <p className="text-lg text-gray-700">{subscriptionData.description}</p>
            </div>
            ...
            <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-700">{subscriptionData.overviewDescription}</p>
            </div>
        </div>
        <Footer/>
                    </>
